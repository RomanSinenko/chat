...
Следующий фокус:
- при подключении пользователя уметь подгружать историю переписки
- вернуть сообщения, которые пришли, пока пользователь был оффлайн
- постепенно убирать временные тестовые HTTP endpoint-ы
- позже усилить список чатов пользователя
...
Текущий фокус:
👉 перейти к подгрузке истории при подключении и оффлайн-сообщениям
